...
public class Teacher_Group_Stat extends Activity {
   // Button btnDatePicker;
    ...
    String productID, serialNumber, childID, userName, sessionsValue, child_token, groupID, groupName;
    EditText txtDate;
   ...
   LinearLayout single_emoji, multiple_emoji;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_group_stat);
...
//series.setValuesOnTopSize(50);
  ...
  /* private void navigatetoLoginActivity() {
    ...
    {
        Intent i = new Intent(Teacher_Group_Stat.this,Welcome.class);
